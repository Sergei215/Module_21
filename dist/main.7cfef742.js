...
document.querySelector(".head-navigation-button-container__button_desktop").addEventListener("click", function () {
  alert("Скрипт запустился---!"), console.log("Скрипт работает");
});
